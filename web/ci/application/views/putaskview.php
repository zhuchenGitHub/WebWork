...
<div style="position:fixed;width:440px;height:350px;left:150px;top:100px;">
<form achtion="<?php echo site_url('putask/index'); ?>" method="post" id="myform">
<label class="word">问题描述：</label>
<p>
<textarea class='textareacss' name='askdiscription' form='myform'><?php echo set_value('askdiscription'); ?></textarea>
</p>
<!--<p><input type='textarea' name='askdiscription' value="<?php echo set_value('askdiscription') ;?>" /></p>-->
<label class="word">问题标签：</label>
<p><input type='text' maxlength="18" name='asklabel' value="<?php echo set_value('asklabel') ;?>" /><span class="word1">（最多输入18个字）</span></p>
