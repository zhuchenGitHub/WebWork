...
<form achtion="http://localhost:81/ci/index.php/searchuser" method="post">

<div style="width:300px;height:60px;margin:auto auto;"><span class="word1">搜索用户</span></div>

<p>
<input type='text' name='searchusername' value='<?php echo set_value('searchusername'); ?>' />
<input type='image' class="searchimg" src='/ci/application/views/image/search.png' name='submit' />
<p>
<span class="word" style="float:left">请输入该用户的完整用户名</span>
</form>
</div>
