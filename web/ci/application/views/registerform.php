...
<span style="font-weight:bold;position:fixed;left:610px;top:220px;font-size:140px;font-family:'幼圆'">Join Us</span>
</div>

<div style="position:fixed;width:390px;height:400px;left:70px;top:210px;">
<form achtion="<?php echo site_url('register/index'); ?>" method="post">
...
<label class="word label">再次输入密码：</label>
<input type="password" name="passwordconfirm" value="<?php echo set_value('password') ?>" size="20" />
<dr />
<p>
